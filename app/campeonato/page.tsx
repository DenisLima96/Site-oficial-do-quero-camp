        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="relative border-l-2 border-gold pl-8 space-y-10">
              ...
              <TimelineItem date="2 de Junho" title="Início do Campeonato">
                Cerimônia de abertura e primeiras partidas da fase de grupos.
              </TimelineItem>
              <TimelineItem date="2 a 20 de Junho" title="Fase de Grupos">
                Partidas da fase de grupos, com jogos de ida e volta.
              </TimelineItem>
              <TimelineItem date="22 de Junho" title="Quartas de Final">
                Confrontos eliminatórios entre os 8 melhores times.
              </TimelineItem>
              <TimelineItem date="24 de Junho" title="Semifinais">
